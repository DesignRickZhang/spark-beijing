...
import com.ibeifeng.sparkproject.test.StreamingExamples
...
object AdClidkRealTimeStatSpark {
  def main(args: Array[String]): Unit = {
    ...
    val Array(zkQuorum, group, numThreads,master) = args
      ...
      val sparkConf = new SparkConf().setAppName("AdClidkRealTimeStatSpark").setMaster("local[2]")
