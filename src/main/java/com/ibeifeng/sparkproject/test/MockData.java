...
public class MockData {
	 ...
	 */
	public static void mock(JavaSparkContext sc,
			SQLContext sqlContext,boolean saveToFile) {
		...
		if(saveToFile)
//		rowsRDD.saveAsTextFile("D:\\beifeng\\user_visit_action");
			df.write().format("json").save("D:\\beifeng\\data\\user_visit_action");
		...
		if(saveToFile)
			df2.write().format("json").save("D:\\beifeng\\data\\user_info");
		...
		if(saveToFile)
			df3.write().format("json").save("D:\\beifeng\\data\\product_info");
