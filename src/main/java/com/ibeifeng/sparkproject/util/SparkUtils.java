...
public class SparkUtils {
	 ...
	 * @param sqlContext
	 */
	public static void mockData(JavaSparkContext sc, SQLContext sqlContext,boolean faveToFile) {
		boolean local = ConfigurationManager.getBoolean(Constants.SPARK_LOCAL);
		if(local) {
			MockData.mock(sc, sqlContext,faveToFile);  
		}
	}
	public static void mockData(JavaSparkContext sc, SQLContext sqlContext) {
		mockData(sc,sqlContext,false);
	}
